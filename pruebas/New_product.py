...
class New_product_window(ctk.CTkToplevel):
    def __init__(self):
        super().__init__()
        self.config_windows()
    ...
    def inputs_maker(self):
        self.input_cod = ctk.CTkEntry(self.search_customerframe,fg_color=COLOR_CUERPO_PRINCIPAL,
                                       placeholder_text='*Obligatorio*', width=200, height=28)
        self.input_cod.place(x = 50, y = 78) 
        
        self.input_name = ctk.CTkEntry(self.search_customerframe,fg_color=COLOR_CUERPO_PRINCIPAL,
                                       placeholder_text='*Obligatorio*', width=200, height=28)
        self.input_name.place(x = 50, y = 136) 
        
        self.input_amount = ctk.CTkEntry(self.search_customerframe,fg_color=COLOR_CUERPO_PRINCIPAL,
                                       placeholder_text='*Obligatorio*', width=200, height=28)
        self.input_amount.place(x = 50, y = 194) 
        
        self.input_price = ctk.CTkEntry(self.search_customerframe,fg_color=COLOR_CUERPO_PRINCIPAL,
                                       placeholder_text='*Obligatorio*', width=200, height=28)
        self.input_price.place(x = 50, y = 252) 
        
           
    def labels_maker(self):
        lblgral =  ctk.CTkLabel(self.search_customerframe, text='Datos del nuevo producto: ',
                                width=40, height=28, fg_color='transparent', text_color=COLOR_GRIS_PASTEL_OSCURO)
        lblgral.place(x = 30, y = 18)
        
        lblcodc =  ctk.CTkLabel(self.search_customerframe, text='Codigo : ', width=40, height=28,
                                  fg_color='transparent', text_color=COLOR_GRIS_PASTEL_OSCURO)
        lblcodc.place(x = 50, y = 50)
        
        lblname =  ctk.CTkLabel(self.search_customerframe, text='Nombre : ', width=40, height=28,
                                  fg_color='transparent', text_color=COLOR_GRIS_PASTEL_OSCURO)
        lblname.place(x = 50, y = 108)
        
        lblaconut =  ctk.CTkLabel(self.search_customerframe, text='Cantidad : ', width=40, height=28,
                                  fg_color='transparent', text_color=COLOR_GRIS_PASTEL_OSCURO)
        lblaconut.place(x = 50, y = 166)
        
        lblprice =  ctk.CTkLabel(self.search_customerframe, text='Precio : ', width=40, height=28,
                                  fg_color='transparent', text_color=COLOR_GRIS_PASTEL_OSCURO)
        lblprice.place(x = 50, y = 225)
